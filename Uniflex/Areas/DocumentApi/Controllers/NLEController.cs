...
{
    public class NLEController : Controller
    {
        [Area("DocumentApi")]
        public IActionResult Index()
        {
            ...
            ViewData["TermialList"] = new Microsoft.AspNetCore.Mvc.Rendering.SelectList(I_HUB.GeneralTable.nle_sp2_itgr_HEADER.getTerminalForDatasource(), "Value", "Text", "ALL");
            ViewData["bList"] = new Microsoft.AspNetCore.Mvc.Rendering.SelectList(I_HUB.GeneralTable.nle_sp2_itgr_HEADER.getBlistForDatasource(), "Value", "Text", "ALL");
            ViewData["bLimit"] = new Microsoft.AspNetCore.Mvc.Rendering.SelectList(I_HUB.GeneralTable.nle_sp2_itgr_HEADER.GetSelectDropDownLimit(), "Value", "Text", "20");
            ViewData["ApikeyList"] = new Microsoft.AspNetCore.Mvc.Rendering.SelectList(BaseUrl.Url_.BaseUrlForList(), "Value", "Text");
                ...
                if (!(string.IsNullOrEmpty(sortColumn) && string.IsNullOrEmpty(sortColumnDir)))
                {
                    switch (sortColumn.ToLower())
                    {
                        default:
                            ...
                            SSP = SSP.OrderBy(o=>o.BL_NO).ToList();
                            break;
                    }
                }
        ...
        [HttpPost]
        public JsonResult GetDetailData([FromForm] string bl_no)
        {
        ...
        [HttpPost]
        public JsonResult ResenDData([FromBody] ILCS.GeneralTable.Lessee_Root lrt)
        {
            ...
            if (lrt.Lessee.Count > 0)
            {
                ...
                if (Base_Url_with_end_point==null)
                {
                ...
                foreach (var x in lrt.Lessee)
                {
                  ...
                  I_HUB.GeneralTable.nle_sp2_itgr nle_Sp2_Itgr = I_HUB.GeneralTable.nle_sp2_itgr.itgr_from_blno(x.bl_no);
                    ...
                    if (response.status.ToString().ToLower() == "success")
                    {
                        ...
                        I_HUB.GeneralTable.nle_sp2_itgr.UpdateStatus("1", Newtonsoft.Json.JsonConvert.SerializeObject(response, Formatting.Indented), x.bl_no);
                    ...
                    {
                        //status gagal
                        I_HUB.GeneralTable.nle_sp2_itgr.UpdateStatus("500", Newtonsoft.Json.JsonConvert.SerializeObject(response, Formatting.Indented), x.bl_no);
                    }
        ...
        [HttpPost]
        public JsonResult DeleteBaseUrl([FromBody] BaseUrl.ApiNama c)
        {
            object o = new { status = "success" };
            List<BaseUrl.Url_> baseurl = BaseUrl.Url_.GetForDataSource();
        ...
        public JsonResult RefreshbaseUrl()
        {
            ...
            try
            {
                ...
                if (!(string.IsNullOrEmpty(sortColumn) && string.IsNullOrEmpty(sortColumnDir)))
                {
                    ...
                    {
                        default:
                            SSP = SSP.OrderBy(o=>o.kode).ToList();
                            break;
                    }
                }
